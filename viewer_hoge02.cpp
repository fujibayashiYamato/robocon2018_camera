...
private:
  ...
  int orbitFlg = 0;
  int key_i_flg = 0;
  #define CAMERA_ANGLE_Y -22.5//degry
  ...
  void pclViewer(){
    ...
    RosSerial serial;
  	...
  	//::PointCloud<pcl::PointXYZRGBA>::Ptr statisticalOutlierCloud(new pcl::PointCloud<pcl::PointXYZRGBA>);
    ...
    //pcl::PointCloud<pcl::PointXYZRGBA>::Ptr calcula(new pcl::PointCloud<pcl::PointXYZRGBA>);
    ...
    long int count = 0;
  	...
  	for(; running && ros::ok();)
  	{
        ...
        orbit.rotationZ(campus,-1.0*M_PI/2.0);
